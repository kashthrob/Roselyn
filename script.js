...
const slides = [
  ...
  const wave = document.getElementById('waveGif');

  audio.addEventListener('play', () => {
    wave.style.display = 'block'; // show GIF when playing
  });

  audio.addEventListener('pause', () => {
    wave.style.display = 'none';  // hide GIF when paused
  });

  audio.addEventListener('ended', () => {
    wave.style.display = 'none';  // hide GIF when audio ends
  });
